...
class MDEditor(object):
    ...
    def __uploads(self):
        ...
        if extension not in ["jpg", "JPG", "jpeg", "JPEG", "gif", "GIF", "png", "PNG", "bmp", "BMP", "webp", "WEBP"]:
    ...
    def context_processor():
        ...
        return {
            "mdeditor": current_app.extensions["mdeditor"],
            "mdeditor_config": current_app.extensions["mdeditor"].config,
        }
